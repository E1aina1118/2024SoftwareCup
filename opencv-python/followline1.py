...
# def put_info(img,centroid,rad,condition,up,down):
#     height, width= img.shape
#     img_rgb = np.stack((img,)*3, axis=-1)
#     color_1 = (255,191,0)
#     color_2 = (0,0,255)
#     if condition == "foward":
#         start_point = (down,height)
#         end_point_1 = (up,0)
#         end_point_2 = (down,0)
#     else:
...
def compute_target(pure_lane):
    ...
    #     if pure_lane[i][height] == 255:
    #         x1 = i
    #         break
    # for i in range(width):
    #     if pure_lane[i][0] == 255:
    #         x3 = i
    #         break
    # for i in range(width):
    #     if pure_lane[width-i][height] == 255:
    #         x2 = i
    #         break
    # for i in range(width):
    #     if pure_lane[width-i][0] == 255:
    #         x4 = i
    #         break
    # up = (x4-x3)*1.0/2
    # down = (x2-x1)*1.0/2
    # target_delta = math.atan((up-down)/height)
    # top_point = (up,0)
    # return target_delta,top_point,up,down
...
def img_callback(msg):
    ...
    if condition == "forward":
        # result,top_point,up,down = compute_target(pure_lane)
        result,top_point = compute_target(pure_lane)
        pub.publish(result)
        # rospy.loginfo("yaw result published")
    elif condition == "angle_appeared":
        result = 0
    ...
    # cv2.imshow("pure_lane_info",put_info(pure_lane,top_point,result,condition,up,down))
...
if __name__ == '__main__':
    ...
    sub = rospy.Subscriber("image",Image,img_callback,queue_size=1)
    rospy.spin()
